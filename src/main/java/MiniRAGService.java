...
public class MiniRAGService {
    interface Assistant {
        @SystemMessage("You are a polite, expert gardening assistant")
        String gardening_query(String text);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<String> lines = Files.readAllLines(Paths.get("src/main/resources/growing_vegetables.txt"));
        ...
        while (true) {
            ...
            var response = cb.gardening_query(cmdline);        // Send everything to the LLM
